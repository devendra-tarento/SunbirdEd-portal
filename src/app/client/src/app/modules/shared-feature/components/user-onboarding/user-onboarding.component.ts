  ...
  selectStage() {
    ...
    return role$.pipe(
      ...
      tap(userType => {
        ...
        // this.stage = showUserSelectionPopup ? Stage.USER_SELECTION : Stage.LOCATION_SELECTION;  //Disable userType and location popup
      }, _ => {
        // this.stage = Stage.USER_SELECTION;   //Disable userType and location popup
      })
    );
  }
